<template>
      ...
      <div class="max-w-xl">
        ...
        <div class="flex justify-center space-x-5">
          <a
              ...
              href="https://github.com/Vahidoghlu/qr-menu/fork"
              target="_blank"
          >
            Fork this Project
          </a>
          <a
              ...
              href="https://github.com/Vahidoghlu/qr-menu"
              target="_blank"
          >
  ...
  <CommonsGenericPanel>
    <div class="flex flex-col">
      ...
      <p class="md:text-lg">Read <a href="https://github.com/Vahidoghlu/qr-menu" class="text-primary">the documentation</a> on how to start quickly.</p>
    </div>
  </CommonsGenericPanel>
